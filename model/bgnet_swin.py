...
class Net(nn.Module):
    def __init__(self):
        ...
        self.add_channel1=nn.Conv2d(128,256,1)
        self.add_channel2=nn.Conv2d(256,512,1)
        self.add_channel3=nn.Conv2d(512,1024,1)
        self.add_channel4=nn.Conv2d(1024,2048,1)
    ...
    def forward(self, x):
        ...
        x1=self.add_channel1(x1)#256*96*96
        x2=self.add_channel2(x2)#512*48*48
        x3=self.add_channel3(x3)#1024*24*24
        x4=self.add_channel4(x4)#2048*12*12
